...
$check_user="SELECT * FROM log WHERE username='$username' OR email='$email'LIMIT 1";
...
if (count($errors)==0) {
	$password=md5($pwd1);
	$qq="INSERT INTO log(username,email,password) VALUES ('$username','$email','$password')";
...
if (isset($_POST['login_user'])) {
	...
	if (count($errors)==0) {
		...
		$qq="SELECT * FROM log WHERE username='$username' AND password='$password'";
