...
<head>
    ...
    <style type="text/css">
		body{
			background-image: url(annie-spratt-102807-unsplash.jpg);
			color: orange;
		}
		li a{
			padding: 10px;
...
<body>
	<nav class="navbar navbar-inverse" style="font-size: 23px;">
		<div class="container fluid">
			...
			<ul class="navbar-nav">
				...
				<li  class="active"><a href="teachlog.php">Teachers Login</a></li>
			</ul>
		</div>
	</nav>
	<div class="motto">
	...
	<form action="teachlog.php" method="post">
		...
		<p>
			...
			<a href="teachreg.php">Register</a>
		</p>
	</form>
</body>
</html>